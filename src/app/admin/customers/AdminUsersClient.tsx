    ...
    <div className="mx-auto w-full max-w-5xl">
      <Card className="overflow-hidden">
        ...
        <div className="p-3 sm:p-4">
          <div className="mb-4 flex flex-wrap items-center gap-3 rounded-xl border bg-white p-3 dark:bg-zinc-800/60 dark:border-zinc-700">
            ...
            <div className="flex gap-1 rounded-full border bg-white p-1 dark:bg-zinc-900 dark:border-zinc-700">
